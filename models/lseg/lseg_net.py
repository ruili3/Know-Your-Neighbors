...
class LSeg(BaseModel):
    def __init__(
        ...
        **kwargs,
        ...
        # print("====clip paramters:{}====".format(sum(p.numel() for p in self.clip_pretrained.parameters())))
        # print("====vision model paramters:{}====".format(sum(p.numel() for p in self.pretrained.parameters())))
        # print("====decoder paramters:{}====".format(sum(p.numel() for p in self.scratch.parameters())))
    ...
    def forward(self, x, labelset=''):
        ...
        print("vit text shape:{}".format(text.shape))
...
# To extract vision-language features in BTS
class LSegFeat(BaseModel):
    def __init__(
        self,
        head,
        features=256,
    ...
    def forward(self, x, labelset=''):
        ...
        # self.scratch.output_conv(image_features)
